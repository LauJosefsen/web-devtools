...
const texts = [
  ...
  'Suscipit nunc tempor elementum platea porta vivamus "Koller er nice". Dapibus vitae enim quis conubia egestas est accumsan. Justo condimentum hendrerit vivamus curabitur dictum dui ultrices porttitor. Erat nam nullam, nostra non ullamcorper dui tortor. Sit viverra mollis, fusce cras eros sapien. Senectus quam bibendum ultrices scelerisque proin.',
  ...
  'Augue fames rhoncus aptent mus; posuere varius metus. Potenti ullamcorper pharetra in ex "Koller er nice" eros torquent quis facilisi. Sem sit ultricies rutrum diam dapibus volutpat vitae lacinia. Sociosqu fames etiam mi auctor; donec rutrum etiam. Torquent tempus augue ex vulputate maximus orci? Proin sociosqu a aliquet, sodales orci tincidunt egestas interdum pretium.',
  'Lobortis "Koller er nice" purus velit. Aliquet integer convallis inceptos class vehicula litora auctor lacus. Neque ornare fusce elit aptent metus. Facilisis eget sit inceptos natoque netus; est montes. Eleifend nunc quis libero eget commodo sodales. Netus purus torquent; vulputate interdum vestibulum etiam primis. Tincidunt facilisis class erat ornare donec orci donec turpis.',
...
export default function Home() {
  return (
    <>
      <h1 className="text-2xl md:text-5xl mb-4 font-bold" id="home">Web dev-tools</h1>

      {texts.map((text, index) => (
        <p key={index} className="py-2 text-l">{text}</p>
      ))}
    </>
  )
}
